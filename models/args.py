...
class ArgumentParserRGBTSegmentation(argparse.ArgumentParser):
    def set_common_args(self):
        ...
        self.add_argument('--lr_decay', default=0.95, type=float)
        self.add_argument('--weight_decay', '--wd', default=0.0005, type=float,
                          help='weight decay')
        ...
        # model
        self.add_argument('--backbone', type=str, default='resnet18')
        self.add_argument('--model_name', '-m', type=str, default='ESANet')
        ...
        self.add_argument('--dataset', default='nyuv2',
                          choices=['sunrgbt',
                                   'nyuv2',
                                   'cityscapes', 'cityscapes-with-thermal',
                                   'scenenetrgbt'])
        ...
        # others
        self.add_argument('--workers', default=0, type=int, metavar='N',
